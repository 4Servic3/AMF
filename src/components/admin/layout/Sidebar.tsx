...
export default function Sidebar({
  ...
  const groupedNav = adminNavigationRegistry
  ...
  return (
    <>
      ...
      <aside
        className={twMerge(
          "amf-admin-sidebar fixed inset-y-0 left-0 z-50 flex flex-col bg-[#12051B] text-cream-50 transition-all duration-300 ease-in-out lg:static lg:translate-x-0 border-r border-[#2A1B3D]/50",
          isOpen ? "translate-x-0" : "-translate-x-full",
          isCollapsed ? "w-[248px] lg:w-[80px]" : "w-[248px]",
        )}
      >
        <div className="flex items-center justify-between h-[72px] px-5 shrink-0">
          <div
            className={twMerge(
              ...
              isCollapsed ? "lg:items-center lg:w-full" : "",
            )}
          >
            <span
              className={twMerge(
                "font-serif text-[28px] leading-none text-[#D4AF37] tracking-wide",
                isCollapsed ? "text-xl" : "",
              )}
            >
              AMF
        ...
        <nav
          className="flex-1 py-4 overflow-y-auto overflow-x-hidden px-3 space-y-6 scrollbar-none"
                  ...
                  >
                    <item.icon
                      ...
                      className={twMerge(
                        ...
                        isActive
                          ? "text-[#D4AF37]"
                          : "text-cream-100/60 group-hover:text-cream-50",
                      )}
                    />
                    <span
                      className={twMerge(
                        "whitespace-nowrap transition-opacity text-[13px] font-medium",
          ...
          >
            ...
            {!isCollapsed && (
              <div className="flex flex-col min-w-0">
                <span className="text-[13px] font-medium text-cream-50 truncate">
                  {name}
                </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <form action={logout}>
              <button
                ...
                className="flex items-center justify-center py-2 px-3 text-cream-100/50 hover:bg-red-500/10 hover:text-red-400 rounded-lg transition-colors"
                title="Sair"
              >
                <LogOut size={16} />
              </button>
