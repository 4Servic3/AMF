...
export default function ChallengePage() {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium">Confirmar sua identidade</h3>
      <form onSubmit={handleVerificar} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={!factorId}
          className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0f615f] hover:bg-[#124b49] disabled:opacity-50"
        >
          Verificar
        </button>
      </form>
