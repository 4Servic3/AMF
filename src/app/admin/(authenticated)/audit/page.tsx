...
export default async function AuditPage() {
  ...
  const supabase = await adminDb("audit.read");
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <PageHeader
          title="Auditoria"
          description="50 eventos administrativos mais recentes."
        />
        <ExportButton />
      </div>
          ...
          <tbody>
            {logs?.map((log: any) => (
              ...
              >
                ...
                <td className="p-3 max-w-xs truncate text-xs text-amf-ink-400">
