      ...
      <header className="amf-member-header w-full bg-[#160820] text-white pt-10 sm:pt-14 pb-8 shrink-0">
        <div className="w-full max-w-4xl mx-auto px-6 relative z-10">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="amf-page-heading text-[20px] font-bold text-white">Meus certificados</h1>
          </div>
        </div>
      </header>
        ...
        <main className="w-full max-w-4xl mx-auto px-6 pt-16 pb-20 min-w-0 flex flex-col">
          {certificates.length === 0 ? (
            <div className="flex flex-col items-center justify-center w-full">
              ...
              <h2 className="amf-section-heading text-[20px] font-editorial text-[#14172A] font-bold mb-2">Nenhum certificado emitido</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              {certificates.map((cert) => (
                <div key={cert.id} className="amf-widget bg-white rounded-2xl border border-gray-200 p-6 shadow-sm flex flex-col items-center text-center relative overflow-hidden">
